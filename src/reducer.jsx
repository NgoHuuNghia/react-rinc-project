const reducer = (state, action) => {
    ...
    if (action.type === 'DISPLAY_FEATURED_LIST'){
        ...
        if (type === 'special') return {...state, featuredListRecent: action.payload.results, loading: false}
        if (type === 'recommended') return {...state, featuredListRecommended: action.payload.results, loading: false}
        if (type === 'sim') return {...state, featuredListSim: action.payload.results, loading: false}
    }
    ...
    if (action.type === 'RUN_SEARCH') return {...state, searchTerm: action.payload}
