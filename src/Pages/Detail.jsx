...
import { FaChevronRight, FaWindows, FaFlag, FaShareAlt } from 'react-icons/fa'
...
const GameDetail = () => {
    return (
        <section className='detail'>
            ...
            <div className='glance'> {/* ADD AGE RATING AND WEBSITE */}
